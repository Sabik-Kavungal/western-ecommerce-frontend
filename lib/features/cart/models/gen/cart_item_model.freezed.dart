...
class _$CartItemModelImpl extends _CartItemModel {
  ...
  @override
  String toString() {
    return 'CartItemModel(product: $product, selectedSize: $selectedSize, selectedColor: $selectedColor, quantity: $quantity)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, product, selectedSize, selectedColor, quantity);
